...
RegisterNetEvent('randol_burgershot:client:cookBurgers', function()
    SetEntityCoords(PlayerPedId(), -1195.57, -898.19, 13.89)
    SetEntityHeading(PlayerPedId(), 343.13)
...
-- vector4(-1191.24, -898.49, 13.89, 202.82)
RegisterNetEvent('randol_burgershot:client:drinkStation', function()
    SetEntityCoords(PlayerPedId(), -1191.24, -898.49, 13.89)
    SetEntityHeading(PlayerPedId(), 202.82)
    exports['qb-menu']:openMenu({
        {
